            ...
            <div className="flex items-center justify-between gap-8 fade-in mt-[130px]">
                ...
                <div className='text-right flex flex-col items-end'>
                    ...
                    <div className="flex gap-4">
                        <button onClick={()=>navigate('/register', {state: {status: 'signup'}})} className="border border-white text-white bg-transparent font-medium px-[2.3vw] py-[1vw]text-[max(1vw,13px)] w-40">
                            Register
                        </button>
                        <button onClick={()=>navigate('/allCars')} className="border-none text-black font-medium px-[2.3vw] py-[1vw] bg-white text-[max(1vw,13px)] w-40">
                            Shop Now
                        </button>
                    </div>
                </div>
